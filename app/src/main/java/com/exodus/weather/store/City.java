...
public class City {
    ...
    @Generated(hash = 473151253)
    public City(Long id, String name, Integer temperature, Integer temp_min, Integer temp_max, java.util.Date updated_at, Integer wind_speed, Integer humidity, String weather_text, String weather_icon) {
        this.id = id;
        this.name = name;
