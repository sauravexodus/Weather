...
public class CityDao extends AbstractDao<City, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Weather_icon = new Property(9, String.class, "weather_icon", false, "WEATHER_ICON");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CITY\" (" + //
                ...
                "\"WEATHER_ICON\" TEXT);"); // 9: weather_icon
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, City entity) {
        ...
        if (weather_icon != null) {
            stmt.bindString(10, weather_icon);
        }
    }
    ...
    public City readEntity(Cursor cursor, int offset) {
        City entity = new City( //
            ...
            cursor.isNull(offset + 9) ? null : cursor.getString(offset + 9) // weather_icon
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, City entity, int offset) {
        ...
        entity.setWeather_icon(cursor.isNull(offset + 9) ? null : cursor.getString(offset + 9));
     }
